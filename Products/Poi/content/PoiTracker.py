...
schema = atapi.Schema((
    ...
    DataGridField(
        ...
        default=({'id': 'ui',
                 ...
                 {'id': 'funcionalidade',
                  ...
                  'description': 'questão com base na funcionalidade'},
                 {'id': 'processo',
                  'title': 'Processo',
                  'description':
                      'Questões relacionadas com o próprio processo de desenvolvimento'}),
    ...
    DataGridField(
        ...
        default=({'id': 'erro',
                  'title': 'Erro',
                  'description': 'Erros da funcionalidade do software'},
                 {'id': 'caracteristica',
                  'title': 'Característica',
                  'description': 'Características sugeridas'},
                 {'id': 'correcao',
                  'title': 'Correção',
                  'description': 'Correção para o software'}),
        widget=DataGridWidget(
    ...
    atapi.LinesField(
        ...
        default=['Crítica', 'Importante', 'Médio', 'Baixo'],
